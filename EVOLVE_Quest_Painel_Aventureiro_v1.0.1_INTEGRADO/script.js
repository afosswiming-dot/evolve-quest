  ...
  async function loadDashboard(userId) {
    ...
    const [profile, journey, assignments, records, checkpoint, subscription, evaluation] = await Promise.all([
      client.from('profiles')
        .select('id, full_name, preferred_name, account_status, access_status, profile_status, current_level, class_id, current_chapter_id, healer_id, adventurer_classes(name), chapters(title, chapter_number)')
